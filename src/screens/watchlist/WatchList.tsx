...
export default function WatchList() {
  ...
  return (
    ...
    >
      ...
      <ScrollView id="movies" className="gap-8">
        <View className="gap-y-2">
          <Text className="text-[25px] font-bold text-purple-600">Ação</Text>
          <ScrollView
            horizontal
            className="gap-2"
          ...
          >
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                ...
                source={{
                  uri: "https://cinevisao.pt/wp-content/uploads/2021/10/Poster-do-filme-Aviso-Vermelho.jpg",
                }}
              />
            </View>
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://i.pinimg.com/736x/39/62/e1/3962e1e01ab44f323f870a156592800a--movie-posters-movies.jpg",
                }}
              />
            </View>
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://d3alv7ekdacjys.cloudfront.net/Custom/Content/Products/11/00/1100211_missao-impossivel-nacao-secreta-filme-acao-ms_m1_637382951111674436.jpg",
                }}
              />
            </View>
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://acontecendoaqui.com.br/wp-content/uploads/2016/04/fox-film-veja.jpg",
                }}
              />
            </View>
          </ScrollView>
        ...
        <View className="gap-y-2">
          <Text className="text-[25px] font-bold text-purple-600">Comédia</Text>
          <ScrollView
            horizontal
            className="gap-2"
            showsHorizontalScrollIndicator={false}
        ...
        <View className="gap-y-2">
          <Text className="text-[25px] font-bold text-purple-600">Drama</Text>
          <ScrollView
            horizontal
            className="gap-2"
            showsHorizontalScrollIndicator={false}
          >
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://br.web.img3.acsta.net/medias/nmedia/18/87/31/05/20028682.jpg",
                }}
              />
            </View>
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://cinema10.com.br/upload/featuredImage.php?url=https%3A%2F%2Fcinema10.com.br%2Fupload%2Ffilmes%2Ffilmes_1258_A+Garota+da+Capa+Vermelha+Poster.jpg",
                }}
              />
            </View>
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://d3alv7ekdacjys.cloudfront.net/Custom/Content/Products/11/01/1101037_um-lugar-para-ser-feliz-dvd-filme-drama-ms_m1_637383524020000753.jpg",
                }}
              />
            </View>
            <View className="h-[150px] w-[100px] border-black border-[.5px] rounded-[20px]">
              <Image
                className="w-full h-full rounded-[20px]"
                source={{
                  uri: "https://i.pinimg.com/236x/18/1c/96/181c96060af6f99f5c99659985b94469--pursuit-of-happiness-the-pursuit-of-happyness.jpg",
                }}
              />
            </View>
          </ScrollView>
